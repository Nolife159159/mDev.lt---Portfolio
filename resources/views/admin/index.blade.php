                ...
                @endif
                    ...
                    <div class="col">
                        <div class="nav flex-md-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link text-white d-block" id="edit-tab" data-toggle="pill" href="#v-edit" role="tab" aria-controls="v-pills-edit" aria-selected="false"><i class="fa fa-pencil fa-1x" aria-hidden="true"></i> Edit a work</a>
